...
using Ensersoft.Clients.Predictions.Predictions;
using Ensersoft.Clients.Predictions.Options;
...
public static class Injection
{
    ...
    public static IServiceCollection AddPredictionsClient(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddHttpClient(InternalApiClients.PredictionsClient)
            ...
            {
                var options = sp.GetRequiredService<PredictionsClientOptions>();

...
using Ensersoft.Clients.Notifications.Options;
...
public static class Injection
{
    ...
    {
        services.AddAndValidateOptions<NotificationsClientOptions>(configuration, "NotificationsService");
        services.AddScoped<INotificationsNotificationsClient, NotificationsNotificationsClient>();
        services.AddHttpClient(InternalApiClients.NotificationsClient)

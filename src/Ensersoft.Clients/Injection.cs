...
using Ensersoft.Clients.Predictor.Predictor;
using Ensersoft.Clients.Options;
using Ensersoft.Clients.Abstractions.Extensions;
using Ensersoft.Clients.Abstractions.Utilities.Http;
...
public static class Injection
{
    ...
    public static IServiceCollection AddPredictorClient(this IServiceCollection services, IConfiguration configuration)
    {
        services.AddAndValidateOptions<PredictorClientOptions>(configuration, "PredictorService");
        services.AddScoped<IPredictorClient, PredictorClient>();
        services.AddHttpClient(InternalApiClients.PredictorClient)
